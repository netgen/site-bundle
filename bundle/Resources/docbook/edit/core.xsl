...
<xsl:stylesheet
    ...
    <xsl:template match="docbook:table | docbook:informaltable">
        <xsl:element name="div" namespace="{$outputNamespace}">
            <xsl:if test="./docbook:ezattribute/docbook:ezvalue[@key='responsive'] = 'true'">
                <xsl:attribute name="class">table-responsive</xsl:attribute>
            </xsl:if>
            <xsl:element name="table" namespace="{$outputNamespace}">
                ...
                <xsl:attribute name="class">
                    <xsl:choose>
                        <xsl:when test="@class">
                            <xsl:choose>
                                <xsl:when test="contains( @class, 'table ' )">
                ...
                <xsl:call-template name="ezattribute"/>
                <xsl:if test="./docbook:ezattribute/docbook:ezvalue[@key='caption'] != ''">
                    <xsl:element name="caption" namespace="{$outputNamespace}">
                        <xsl:value-of select="./docbook:ezattribute/docbook:ezvalue[@key='caption']"/>
                    </xsl:element>
                </xsl:if>

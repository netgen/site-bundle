...
final class SiteEvents
{
     ...
     */
    public const string USER_ACTIVATION_REQUEST = 'ngsite.events.user.activation_request';
     ...
     */
    public const string USER_PRE_ACTIVATE = 'ngsite.events.user.pre_activate';
     ...
     */
    public const string USER_POST_ACTIVATE = 'ngsite.events.user.post_activate';
     ...
     */
    public const string USER_PRE_REGISTER = 'ngsite.events.user.pre_register';
     ...
     */
    public const string USER_POST_REGISTER = 'ngsite.events.user.post_register';
     ...
     */
    public const string USER_PASSWORD_RESET_REQUEST = 'ngsite.events.user.password_reset_request';
     ...
     */
    public const string USER_PRE_PASSWORD_RESET = 'ngsite.events.user.pre_password_reset';
     ...
     */
    public const string USER_POST_PASSWORD_RESET = 'ngsite.events.user.post_password_reset';
     ...
     */
    public const string CONTENT_DOWNLOAD = 'ngsite.events.content.download';
     ...
     */
    public const string MENU_LOCATION_ITEM = 'ngsite.events.menu.location_item';
}
